...
public class UnPeekLiveData<T> extends ProtectedUnPeekLiveData<T> {
    ...
    public static class Builder<T> {
        ...
        public com.examply.architecture.ui.callback.UnPeekLiveData<T> create() {
            com.examply.architecture.ui.callback.UnPeekLiveData<T> liveData = new com.examply.architecture.ui.callback.UnPeekLiveData<>();
