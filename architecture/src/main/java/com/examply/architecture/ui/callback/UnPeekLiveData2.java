 ...
 */
public class UnPeekLiveData2<T> extends ProtectedUnPeekLiveData2<T> {
    ...
    public static class Builder<T> {
         ...
         * 是否自动清除消息, 默认自动清除
         */
        private boolean isAutoClearValue = true;
        ...
        public Builder<T> setAutoClearValue(boolean isAutoClearValue) {
            this.isAutoClearValue = isAutoClearValue;
            return this;
        }

        public com.examply.architecture.ui.callback.UnPeekLiveData2<T> create() {
            com.examply.architecture.ui.callback.UnPeekLiveData2<T> liveData = new com.examply.architecture.ui.callback.UnPeekLiveData2<>();
            liveData.isAllowNullValue = this.isAllowNullValue;
            liveData.isAutoClearValue = this.isAutoClearValue;
            return liveData;
        }
    }
}