...
package com.examply.xpuremusic.player.notification;
...
import com.examply.architecture.utils.ImageUtils;
import com.examply.xpuremusic.MainActivity;
import com.examply.xpuremusic.data.bean.TestAlbum;
import com.examply.xpuremusic.data.config.Configs;
import com.examply.xpuremusic.domain.usecase.DownloadUseCase;
import com.examply.xpuremusic.player.PlayerManager;
import com.examply.xpuremusic.player.helper.PlayerCallHelper;
    ...
    private void createNotification(TestAlbum.TestMusic testMusic) {
        try {
            ...
            if (bitmap != null) {
                ...
                notification.contentView.setImageViewResource(R.id.player_album_art, R.mipmap.bg_album_default);
                notification.bigContentView.setImageViewResource(R.id.player_album_art, R.mipmap.bg_album_default);
            }
